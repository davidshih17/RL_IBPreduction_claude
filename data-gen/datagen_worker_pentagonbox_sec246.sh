...
# RESTRICTED TO SECTOR 246 (L6 with D0 and D3 off) — dedicated dataset for
# the OOD regime where the 10x_loop_100 model gets stuck on the (8,4)
# integral I[-1,2,1,0,1,2,1,1,-3,0,0].
#
# Usage:
#   ./datagen_worker_pentagonbox_sec246.sh <worker_id> [n_scrambles] [output_dir]

set -e

WORKER_ID=$1
N_SCRAMBLES=${2:-400}
OUTPUT_DIR=${3:-${SAILIR_DIR}/data/pentagonbox_sec246_raw_jsonl}
...
OUTPUT_FILE="${OUTPUT_DIR}/multisector_data_sec246_worker${WORKER_ID}.jsonl"

echo "========================================"
echo "SAILIR pentagon-box sec246 data-gen worker"
echo "========================================"
echo "Worker ID:    ${WORKER_ID}"
echo "Start seed:   ${START_SEED}"
echo "N scrambles:  ${N_SCRAMBLES}"
echo "Output file:  ${OUTPUT_FILE}"
echo "Restrict to:  sector_id 246 (L6, D0 & D3 off)"
echo "========================================"
