#!/bin/bash
# Instrumented (8,4) probe: full16_v2 + DELTA_P4_INSTR=1.
# Will print P4_PARALLEL_INSTR line per step showing fork/wait/worker/read/apply breakdown.
set -e

BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_84_delta_p4instr
mkdir -p $OUTDIR
