#!/bin/bash
# Long-runner probe with FULL memory breakdown instrumentation.
set -e
BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_longrunner_v6_memprobe
mkdir -p $OUTDIR
...
environment = "PYTHONUNBUFFERED=1 MALLOC_MMAP_THRESHOLD_=67108864 SAILIR_END_OF_STEP_TRIM=1 SAILIR_MEMPROBE_FULL=$OUTDIR/memprobe.jsonl SAILIR_MEMPROBE_FULL_STEPS=30,50,100,200,500,800"
