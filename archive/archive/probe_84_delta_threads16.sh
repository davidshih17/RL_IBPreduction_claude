#!/bin/bash
# (8,4) probe with torch n_threads=4 + request_cpus=4 to measure how
# much P2 (model inference) speeds up with BLAS multi-threading.
# Same Cython build as probe_84_delta_cy3; just bumps thread count.
set -e

BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_84_delta_threads16
mkdir -p $OUTDIR
