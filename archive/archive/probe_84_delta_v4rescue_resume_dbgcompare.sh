#!/bin/bash
# Resume from v4-rescue's step-175 snapshot (.preDiv) with DELTA_DEBUG_COMPARE=1.
# Walks the rescue-emitted survivor paths; if rescue is incomplete for some
# state-pattern the original replay didn't visit, this WILL catch it on the
# new paths.
set -e
BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
SRC_CKPT=$BASE/results/probe_84_delta_v4_rescue/result.pkl.ckpt.r1.preDiv
OUTDIR=$BASE/results/probe_84_delta_v4rescue_resume_dbgcompare
mkdir -p $OUTDIR
