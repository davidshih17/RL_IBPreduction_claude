#!/bin/bash
# Login-node run of the extreme TABU failure case.
# Same env + args as the condor probe, but executes directly here.
set -e
...
export SAILIR_TABU_RECOVERY=1 SAILIR_DUMP_STUCK=$OUTDIR/stuck_state.pkl
