#!/bin/bash
# Probe (7,4) with tracemalloc instrumentation. Outputs to
# results/probe_74_v6_memprofile/. Uses the PREFIX (baseline) code path so
# the profile reflects the canonical reduction (no Fix #11 noise).
set -e
BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_74_v6_memprofile
mkdir -p $OUTDIR
