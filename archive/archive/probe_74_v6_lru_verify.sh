#!/bin/bash
# Clean LRU verification (no memprobe, no chunking, no malloc_trim).
# LRU is now default-on at cap=50000 via IBPEnvironment.__init__.
set -e
BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_74_v6_lru_verify
mkdir -p $OUTDIR
