...
OUTDIR=$BASE/results/pentagonbox_8_5_v6_round2/memdiag_trim
mkdir -p $OUTDIR
...
environment = "PYTHONUNBUFFERED=1 SAILIR_MEM_BREAKDOWN=1 SAILIR_MEM_BREAKDOWN_EVERY=25 SAILIR_END_OF_STEP_TRIM=1 MALLOC_MMAP_THRESHOLD_=67108864"
