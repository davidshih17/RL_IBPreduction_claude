...
# Usage: ./datagen_worker_filter_lateral.sh <worker_id> <n_scrambles> <output_dir>

set -e

WORKER_ID=$1
N_SCRAMBLES=${2:-1000}
OUTPUT_DIR=${3:-/het/p4/dshih/jet_images-deep_learning/RL_IBPreduction_claude/data/multisector_filter_lateral}
