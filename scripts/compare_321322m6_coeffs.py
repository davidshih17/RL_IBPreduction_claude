#!/usr/bin/env python3
"""
Compare coefficients for I[3,2,1,3,2,2,-6] between our async reduction and Kira
"""

# Our 16 masters from async_321322m6_papermasters_v2.log
our_masters = {
    (1, 0, 1, 1, 1, 1, 0): 171,
    (1, 1, 0, 1, 1, 1, 0): 854,
    (1, 1, 1, 1, 1, 0, 0): 377,
    ...
    (1, 1, 0, 1, 1, 0, 0): 794,
    (0, 0, 1, 1, 1, 0, 0): 502,
    (0, 1, 1, 1, 0, 0, 0): 320,  # Note: Kira has 267 for this!
    (1, 0, 1, 0, 0, 1, 0): 956,  # Kira doesn't have this
    (1, 0, 1, 0, 1, 0, 0): 944,
}
...
kira_masters = {
    ...
    (0, 0, 1, 1, 1, 0, 0): 502,
    (1, 0, 1, 0, 1, 0, 0): 944,
    (0, 1, 1, 1, 0, 0, 0): 267,  # Note: We have 320 for this!
    (1, 1, 0, 1, 1, 1, 0): 854,
    (1, 0, 0, 1, 1, 1, 0): 197,
    (1, 1, 0, 1, 1, 0, 0): 794,
    (1, 1, 0, 1, 0, 1, 0): 143,
...
print("=" * 80)
print("Comparing I[3,2,1,3,2,2,-6] coefficients: Our result vs Kira")
print("=" * 80)
