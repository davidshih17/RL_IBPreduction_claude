...
MODEL_CKPT = f'{BASE}/checkpoints/pentagonbox_10x_loop_100/best_model.pt'
DATA_DIR = f'{BASE}/data/pentagonbox_sec246_packed'
OUT_DIR = f'{BASE}/checkpoints/pentagonbox_10x_sec246_finetune_v1'
...
print("=" * 70, flush=True)
print(f"Fine-tune pentagonbox_10x_loop_100 on sec246 data", flush=True)
print("=" * 70, flush=True)
print(f"Model checkpoint:  {MODEL_CKPT}", flush=True)
...
ckpt = torch.load(MODEL_CKPT, weights_only=False, map_location=DEVICE)
