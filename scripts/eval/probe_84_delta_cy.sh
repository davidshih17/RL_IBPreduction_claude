#!/bin/bash
# (8,4) probe with Cython Phase 1b fast path. Compare to
# results/probe_84_delta_p1instr/ (6872s, P1=12s at late step) for speedup.
set -e

BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_84_delta_cy
mkdir -p $OUTDIR
