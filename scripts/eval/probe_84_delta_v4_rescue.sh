#!/bin/bash
# v4 + Phase 0 rescue (the fix for the multi-K dedup bug). Clean run from
# scratch with default thin checkpoints, NO compare overhead. Diff against
# baseline 1541690's checkpoint at matched step to verify bit-identical
# survivor paths.
set -e
BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_84_delta_v4_rescue
mkdir -p $OUTDIR
