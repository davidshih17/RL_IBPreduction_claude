#!/bin/bash
# (8,4) probe — P4 fold (union_bm computed inline inside
# apply_resolved_subs_batch, removing the separate cached_union_bitmask pass
# in compute_indirect_substituted).
set -e

BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_84_p4fold
mkdir -p $OUTDIR
