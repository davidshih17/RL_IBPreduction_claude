#!/bin/bash
# (8,4) probe via delta-tracking serial worker.
# Compare wall time + final path/expr to reference at
# results/probe_84_p3instr/ (1335s, 261 steps, 64-term final_expr).
set -e

BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_84_delta
mkdir -p $OUTDIR
