#!/bin/bash
# (8,4) probe with the FULL parallel stack:
#   --n_threads 16        : BLAS threading for P2
#   DELTA_P1_WORKERS=16   : fork-parallel gv calls
#   DELTA_P3_WORKERS=16   : fork-parallel candidate apply
#   DELTA_P4_WORKERS=16   : fork-parallel aux materialization
# request_cpus = 16 to match.
set -e

BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_84_delta_full16
mkdir -p $OUTDIR
