#!/bin/bash
# Long-runner probe with iraws-key refactor + LRU-bounded raw_eq_cache.
set -e
BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_longrunner_v6_iraws_lru
mkdir -p $OUTDIR
...
environment = "PYTHONUNBUFFERED=1 SAILIR_RAW_EQ_CACHE_CAP=20000"
