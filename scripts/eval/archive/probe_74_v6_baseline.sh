#!/bin/bash
# Baseline (PRE-Fix-#11) re-run of the (7,4) probe, using the reverted
# beam_search_v6_prefix.py. Output to results/probe_74_v6_baseline/ so it
# doesn't clobber the post-fix probe_74_v6/.
set -e
BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_74_v6_baseline
mkdir -p $OUTDIR
PYTHON=/het/p4/dshih/jet_images-deep_learning/RL_MIR_IBP/conda_env/bin/python
MODEL=$BASE/checkpoints/pentagonbox_10x_loop_100/best_model.pt
TOPOLOGY=$BASE/topology_input/pentagonbox
INTEGRAL_STR="0,1,1,1,1,1,1,1,-4,0,0"
SCRIPT=$BASE/scripts/eval/archive/beam_search_v6_prefix.py
