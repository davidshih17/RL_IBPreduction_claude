#!/bin/bash
# old-delta (SEED_MERGE=0) then new-delta (=1) back-to-back, SAME node. Only the
# delta form differs. Full output -> results/abseed/.
B=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
PY=/het/p4/dshih/jet_images-deep_learning/RL_MIR_IBP/conda_env/bin/python
SC=$B/scripts/eval/beam_search_v7.py; O=$B/results/abseed
