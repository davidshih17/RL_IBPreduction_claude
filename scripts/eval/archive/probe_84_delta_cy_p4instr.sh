#!/bin/bash
# (8,4) probe with Cython phase1b + P4 sub-breakdown +
# BEAM_PROFILE_CIC_INC=1 — full instrumentation of incremental aux.
set -e

BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_84_delta_cy_p4instr
mkdir -p $OUTDIR
