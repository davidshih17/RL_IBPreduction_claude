...
OUTDIR=$BASE/results/probe_74_v6_prof
mkdir -p $OUTDIR
...
environment = "PYTHONUNBUFFERED=1 V5_PROFILE=1 MALLOC_MMAP_THRESHOLD_=67108864 SAILIR_END_OF_STEP_TRIM=1 SAILIR_TABU_CAP=0"
