#!/bin/bash
# (7,4) probe with the any() termination fix AND --beam-sort weight (not mixed).
# Other args match probe_74_v5_lazyrs_fresh: LAZY_RS + iraws-keep-first 50 + tabu.
set -e
BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_74_v5_anyfix_sortweight
mkdir -p $OUTDIR
