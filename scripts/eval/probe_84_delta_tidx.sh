#!/bin/bash
# (8,4) probe with target-keyed reverse index (tidx) fast path enabled.
# Compare to results/probe_84_delta_p1instr/ (no tidx, 6872s) for speedup.
set -e

BASE=/het/p4/dshih/jet_images-deep_learning/SAILIR_phase2
OUTDIR=$BASE/results/probe_84_delta_tidx
mkdir -p $OUTDIR
...
environment = "PYTHONUNBUFFERED=1 P1_INSTRUMENT=1"
